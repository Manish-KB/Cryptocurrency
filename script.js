...
document.querySelector("#start-trade").addEventListener("click", showPopup);
...
function renderTable() {
  ...
  paginatedData.forEach((coin, index) => {
    ...
    if (priceChange > 0) {
      ...
      priceChangeArrow = '<i class="fa-solid fa-arrow-up"></i>';
      console.log(priceChange);
    } else if (priceChange < 0) {
      priceChangeColor = 'red';
      priceChangeArrow = '<i class="fa-solid fa-arrow-down"></i>';
    } else {
